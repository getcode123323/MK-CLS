...
#Here are all the experimental models of RQ3 (LR,RF,SVM,RVM)
#Choose which model to import here, and then apply the model at line 272
from MK-CLS import trained_CL
# from baseline1_RF import trained_CL
# from baseline2_LR import trained_CL
# from baseline3_SVM import trained_CL
# from baseline4_RVM import trained_CL
...
def evaluteModelWithWeights(bestWeight,targetLabel,folder, task, logFolder, method,saveModel=False):
        ...
        if task=="HC":
            ...
            #This is LR
            # X_train,Y_train=trained_CL(X_train, Y_train)
            #This is RF
            # X_train,Y_train=trained_CL(X_train, Y_train)
            #This is SVM
            # X_train,Y_train=trained_CL(X_train, Y_train)
