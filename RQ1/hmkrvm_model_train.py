...
#Here are all the experimental models of RQ1 (MK-CLS, OSS, CLNI, E2SC, IS)
#Choose which model to import here, and then apply the model at line 272
from MK-CLS import trained_CL
# from E2SC.baseline_e2sc import trained_E2SC
# from baseline_isolation_forest import trained_IS
# from baseline_CLNI import trained_CLNI
# from baseline_OSSimport trained_OSS
...
def evaluteModelWithWeights(bestWeight,targetLabel,folder, task, logFolder, method,saveModel=False):
        ...
        if task=="HC":
            ...
            #This is OSS
            # X_train,Y_train=trained_OSS(X_train, Y_train)
            #This is isolation_forest
            # X_train,Y_train=trained_IS(X_train, Y_train)
            #This is E2SC
            # X_train,Y_train=trained_E2SC(X_train, Y_train)
        # evaluate model
        result = evaluteWeightsOnTest(bestWeight, X_train, X_test, Y_train, Y_test, attempts=10)
